...
public final class TestAccounts {
  ...
  public static EscrowAnalysis analysis(
      LocalDate date, BigDecimal balance, BigDecimal projectedTax, BigDecimal shortage) {
    BigDecimal shortageMonthly =
        shortage.divide(new BigDecimal("12"), 2, java.math.RoundingMode.HALF_UP);
  ...
  public static MortgageAccount account(
      EscrowAnalysis oldAnalysis, EscrowAnalysis newAnalysis, List<EscrowTransaction> ledger) {
    return new MortgageAccount(
        ...
        List.of(
            new TaxBill(
                ...
                2024,
                amount("6000.00"),
                List.of(LocalDate.of(2024, 6, 15), LocalDate.of(2024, 12, 15))),
            new TaxBill(
                "County",
                2025,
                amount("6000.00"),
        ...
        List.of(
            analysis(
                LocalDate.of(2024, 1, 1), amount("1200.00"), amount("6000.00"), amount("400.00")),
            oldAnalysis,
            newAnalysis));
  }
  ...
  public static ReconciliationContext context(
      MortgageAccount account, BigDecimal expectedShortage, PaymentDecomposition decomposition) {
