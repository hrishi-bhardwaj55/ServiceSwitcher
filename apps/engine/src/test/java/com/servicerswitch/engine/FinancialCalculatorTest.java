...
class FinancialCalculatorTest {
  ...
  void recomputesWorkedEscrowShortageExample() {
    ...
    MortgageAccount account =
        new MortgageAccount(
            ...
            base.annualRate(),
            base.termMonths(),
            base.originationDate(),
            base.servicingPeriods(),
            base.payments(),
            base.escrowLedger(),
            List.of(
                new TaxBill(
  ...
  void emitsExactExplainedPaymentDecomposition() {
    ...
    PaymentDecomposition result =
        new PaymentCalculator().decompose(account, TestAccounts.TRANSFER_DATE);
